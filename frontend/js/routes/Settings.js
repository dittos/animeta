...
import { changePassword, disconnectTwitter, logout } from '../API';
        ...
        return (
            <Layout.CenteredFullWidth>
                ...
                {currentUser.is_twitter_connected ? (
                    <button onClick={this._disconnectTwitter.bind(this)}>
                        연결 끊기
                    </button>
                ) : (
                    <button onClick={this._connectTwitter.bind(this)}>
                        연결하기
                    </button>
                )}
