                    ...
                    {['watching', 'finished', 'suspended', 'interested'].map(
                        statusType => (
                            ...
                            >
                                ...
                                >
                                    {util.STATUS_TYPE_TEXT[statusType]} ({this
                                        .props.statusTypeStats[statusType] ||
                                        0})
                                </Link>
                            </div>
                        )
                    ...
                    {[{ id: 0, name: '지정 안함' }]
                        ...
                        .map(category => (
                            ...
                            >
                                ...
                                >
                                    {category.name} ({this.props.categoryStats[
                                        category.id
                                    ] || 0})
                                </Link>
                            </div>
        ...
        return (
            <Grid.Row className={Styles.library}>
                <Grid.Column size={3} pull="left">
                    ...
                    <div
                        className={
                            this.state.mobileFilterVisible ? '' : 'hide-mobile'
                        }
                    >
                        <LibraryFilter
                            count={count}
