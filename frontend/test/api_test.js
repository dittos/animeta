...
describe('API.merge', () => {
    ...
    it('should merge plain objects', () => {
        ...
        assert.deepEqual(merge({user: {}}, {user: {stats: true}}), {user: {stats: true}});
        assert.deepEqual(merge({user: {stats: true}}, {user: {}}), {user: {stats: true}});
        assert.deepEqual(merge({record: {user: {}}}, {}), {record: {user: {}}});
        assert.deepEqual(merge({record: {user: {}}}, {record: {}}), {record: {user: {}}});
    });
});