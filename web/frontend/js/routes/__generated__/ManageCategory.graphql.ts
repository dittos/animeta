...
export type ManageCategoryRouteQuery = { __typename?: 'Query', currentUser: { __typename?: 'User', categories: Array<{ __typename?: 'Category', databaseId: string, name: string }> } | null };
