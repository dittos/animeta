...
export type ManageCategoryRouteQuery = { __typename?: 'Query', currentUser: { __typename?: 'User', name: string | null, joinedAt: any | null, isCurrentUser: boolean, recordCount: number | null, postCount: number | null, categories: Array<{ __typename?: 'Category', databaseId: string, name: string }> } | null };

export type ManageCategory_CategoryFragment = { __typename?: 'Category', databaseId: string, name: string };
...
export type ManageCategory_CreateCategoryMutation = { __typename?: 'Mutation', createCategory: { __typename?: 'CreateCategoryResult', category: { __typename?: 'Category', databaseId: string, name: string } } };
...
export type ManageCategory_RenameCategoryMutation = { __typename?: 'Mutation', renameCategory: { __typename?: 'RenameCategoryResult', category: { __typename?: 'Category', databaseId: string, name: string } } };
...
export type ManageCategory_UpdateCategoryOrderMutation = { __typename?: 'Mutation', updateCategoryOrder: { __typename?: 'UpdateCategoryOrderResult', categories: Array<{ __typename?: 'Category', databaseId: string, name: string }> } };
