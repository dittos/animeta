...
export type AddRecordDialogQuery = { __typename?: 'Query', currentUser: { __typename?: 'User', isTwitterConnected: boolean | null, categories: Array<{ __typename?: 'Category', id: string, name: string }> } | null };

export type AddRecordDialog_CategoryFragment = { __typename?: 'Category', id: string, name: string };
