...
import { GqlWorkStatusButton_RecordFragment, GqlWorkStatusButton_WorkFragment } from './__generated__/GqlWorkStatusButton.graphql';

export function GqlWorkStatusButton({ work, record, currentUser }: {
  work: GqlWorkStatusButton_WorkFragment;
  record?: GqlWorkStatusButton_RecordFragment | null;
